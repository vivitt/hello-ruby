class TareasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @tarea.save
        format.html { redirect_to root_url(@tarea), notice: "Task successfully created :)" }
  ...
  def update
    respond_to do |format|
      if @tarea.update(tarea_params)
        format.html { redirect_to root_url(@tarea), notice: "Task successfully updated" }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to root_url(@tarea), notice: "Task successfully deleted" }
